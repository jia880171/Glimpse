...
extension JournalQueryLinks
    on QueryBuilder<Journal, Journal, QFilterCondition> {
  QueryBuilder<Journal, Journal, QAfterFilterCondition> friends(
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> friendsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> friendsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'friends', 0, true, 0, true);
    });
  }

  QueryBuilder<Journal, Journal, QAfterFilterCondition> friendsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'friends', 0, false, 999999, true);
    });
  }

  QueryBuilder<Journal, Journal, QAfterFilterCondition> friendsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Journal, Journal, QAfterFilterCondition> friendsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
